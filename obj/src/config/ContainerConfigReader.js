...
class ContainerConfigReader {
    ...
    static readFromJsonFile(correlationId, path, parameters) {
        let config = pip_services3_components_nodex_1.JsonConfigReader.readConfig(correlationId, path, parameters);
    ...
    static readFromYamlFile(correlationId, path, parameters) {
        let config = pip_services3_components_nodex_2.YamlConfigReader.readConfig(correlationId, path, parameters);
        return ContainerConfig_1.ContainerConfig.fromConfig(config);
    }
}
